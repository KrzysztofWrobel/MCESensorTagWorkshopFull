    ...
    private void onSampleClick(Samples sample) {
        ...
        switch (sample) {
            ...
            case MAGNETOMETER:
                ...
                deviceAddresses.add(MY_FIRST_SENSOR_TAG_MAC);
            ...
            case BUTTON_GAME:
                ...
                deviceAddresses1.add(MY_FIRST_SENSOR_TAG_MAC);
                deviceAddresses1.add(MY_SECOND_SENSOR_TAG_MAC);
            ...
            case BAROMETER:
                ...
                deviceAddresses2.add(MY_FIRST_SENSOR_TAG_MAC);
